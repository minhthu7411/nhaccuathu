    ...
    songs: [
        {
            ...
            singer: "mer",
            path: "./assets/music/tâm (orchestra version) - mer.mp3",
            image: "./assets/img/tam-v2.jpg",
        }, 
        {
            name: "Tâm",
            singer: "Mer",
            path: "./assets/music/tâm - mer.mp3",
            image: "./assets/img/tam.jpg",
        },
        {
            name: "Somewhere",
            singer: "Groovyroom (Feat. Suran, pH-1)",
            path: "./assets/music/어디쯤에(Somewhere) - GroovyRoom (그루비룸) (Feat. Suran, pH-1).mp3",
            image: "./assets/img/somewhere.jpg",
        },
        {
            name: "Chiếc Ghế Trống",
            singer: "Mer",
            path: "./assets/music/Chiếc Ghế Trống (A song in support of UNICEF) - Mer.mp3",
        ...
        },
        {
            name: "Nụ hôn Bisou",
            singer: "Mike",
            path: "./assets/music/Nụ hôn Bisou - Mike.mp3",
        ...
        },
        {
            ...
            singer: "Ngọt",
            path: "./assets/music/LẦN CUỐI (đi bên em xót xa người ơi) - Ngọt.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Stay With Me - Miki Matsubara.mp3",
            image: "./assets/img/staywithme.jpg",
        },
        {
            name: "Cung đường lẻ loi",
            singer: "Mikelodic",
            path: "./assets/music/Cung đường lẻ loi - Mikelodic.mp3",
            image: "./assets/img/mike.jpg",
        },
        {
            name: "Traveler",
            singer: "숀 (SHAUN)",
            path: "./assets/music/Traveler - 숀 (SHAUN).mp3",
        ...
        },
        {
            name: "Out of Time",
            singer: "The Weekend",
            path: "./assets/music/Out of Time - The Weekend.mp3",
        ...
        },
        {
            ...
            singer: "Mike",
            path: "./assets/music/lời tâm sự số 3 - Mike.mp3",
        ...
        },
        {
            name: "Thanh Bần",
            singer: "Mike",
            path: "./assets/music/Thanh Bần - Mike.mp3",
            image: "./assets/img/thanhban.jpg",
        },
        {
            name: "Lần cuối",
            singer: "Hoaprox x Dex Rework feat. Dang Minh",
            path: "./assets/music/Lần cuối - (Hoaprox x Dex Rework) feat. Dang Minh.mp3",
            image: "./assets/img/lancuoihoaprox.jpg",
        },
        {
            name: "nguyên xi",
            singer: "Mike x Namlee",
            path: "./assets/music/nguyên xi (mv 8K 18 triệu màu) - Mike x Namcocain.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Em Không Đi Đâu - QNT (feat. Giang).mp3",
        ...
        },
        {
            name: "Huyền Vi",
            singer: "Masew",
            path: "./assets/music/HUYỀN VI - MASEW.mp3",
            image: "./assets/img/huyenvi.jpg",
        },
        {
            name: "CORNER STORE",
            singer: "MACKLEMORE FEAT DAVE B & TRAVIS THOMPSON",
            path: "./assets/music/CORNER STORE - MACKLEMORE FEAT DAVE B & TRAVIS THOMPSON.mp3",
            image: "./assets/img/cornerstore.jpg",
        },
        {
            name: "Happier",
            singer: "Marshmello ft. Bastille",
            path: "./assets/music/Happier - Marshmello ft. Bastille.mp3",
            image: "./assets/img/happier.jpg",
        },
        {
            name: "Du Miên",
            singer: "Mer",
            path: "./assets/music/DU MIÊN - MER.mp3",
            image: "./assets/img/dumien.jpg",
        },
        {
            name: "Ước hẹn thiện duyên",
            singer: "Mer",
            path: "./assets/music/ƯỚC HẸN THIỆN DUYÊN - Mer.mp3",
        ...
        },
        {
            name: "Chuyện Dở Dang",
            singer: "Ngọt",
            path: "./assets/music/Chuyen Do Dang - Ngọt.mp3",
            image: "./assets/img/suyt.jpg",
        },
        {
            name: "Chuyển Kênh",
            singer: "Ngọt",
            path: "./assets/music/CHUYỂN KÊNH (sản phẩm này không phải là thuốc) - Ngọt.mp3",
            image: "./assets/img/chuyenkenh.jpg",
        },
        {
            name: "Thấy Chưa",
            singer: "Ngọt",
            path: "./assets/music/Thấy Chưa - Ngọt.mp3",
            image: "./assets/img/thaychua.jpg",
        },
        {
            name: "Cho Tôi Lang Thang",
            singer: "Ngọt ft. Đen",
            path: "./assets/music/Cho Tôi Lang Thang - Ngọt vc. Đen.mp3",
            image: "./assets/img/chotoilangthang.jpg",
        },
        {
            name: "NGƯỜI BÌNH THƯỜNG",
            singer: "VŨ CÁT TƯỜNG",
            path: "./assets/music/NGƯỜI BÌNH THƯỜNG - VŨ CÁT TƯỜNG.mp3",
            image: "./assets/img/nguoibinhthuong.jpg",
        },
        {
            name: "Chết đi cho rồi",
            singer: "Nguyễn Hồng Giang (feat Cam & Quỳnh)",
            path: "./assets/music/Chết đi cho rồi - Nguyễn Hồng Giang (feat Cam & Quỳnh).mp3",
        ...
        },
        {
            name: "Hay Là",
            singer: "Ngọt",
            path: "./assets/music/Hay La - Ngọt.mp3",
            image: "./assets/img/suyt.jpg",
        },
        {
            name: "Vui Vẻ",
            singer: "Oát x Astronormous",
            path: "./assets/music/Vui Vẻ - Oát x Astronormous.mp3",
            image: "./assets/img/vuive.png",
        },
        {
            name: "Tell The Kids I Love Them",
            singer: "Obito ft. SHIKI",
            path: "./assets/music/Tell The Kids I Love Them - Obito ft. SHIKI.mp3",
            image: "./assets/img/obito.jpg",
        },
        {
            name: "Phép Màu",
            singer: "Mounter x MAYDAYs, Minh Tốc",
            path: "./assets/music/Phép Màu - Maydays.mp3",
            image: "./assets/img/phepmau.jpg",
        },
        {
            name: "Quen Lắm",
            singer: "Ngọt",
            path: "./assets/music/Quen Lắm - Ngọt.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Rather Be x Without Me [Mashup] - Eminem ft. Clean Bandit.mp3",
            image: "./assets/img/ratherbexwithoutme.jpg",
        },
        {
            name: "These Days",
            singer: "Rudimental (feat. Jess Glynne, Macklemore & Dan Caplen)",
            path: "./assets/music/These Days - Rudimental (feat. Jess Glynne, Macklemore & Dan Caplen).mp3",
            image: "./assets/img/thesedays.jpg",
        },
        {
            name: "SAY EM",
            singer: "QNT ft. REFUND BAND",
            path: "./assets/music/SAY EM - QNT ft. REFUND BAND.mp3",
            image: "./assets/img/sayem.jpg",
        },
        {
            name: "Hướng Dương",
            singer: "Thắng",
            path: "./assets/music/Hướng Dương - Thắng.mp3",
        ...
        },
        {
            name: "Soạn",
            singer: "The Cassette",
            path: "./assets/music/Soạn - The Cassette.mp3",
            image: "./assets/img/soan.jpg",
        },
        {
            name: "Treo (2-00 AM)",
            singer: "The Cassette",
            path: "./assets/music/Treo (2-00 AM) - The Cassette.mp3",
            image: "./assets/img/treo.jpg",
        },
        {
            name: "Nhớ Một Người",
            singer: "THE SHEEP",
            path: "./assets/music/Nhớ Một Người - THE SHEEP.mp3",
            image: "./assets/img/nhomotnguoi.jpg",
        },
        {
            name: "Tình Thật Tình Mơ",
            singer: "Mer",
            path: "./assets/music/Tình Thật Tình Mơ - Mer.mp3",
            image: "./assets/img/tinhthattinhmo.jpg",
        },
        {
            name: "LONELY LOVE",
            singer: "Trang Hàn x TDK x Hoàng Thống",
            path: "./assets/music/LONELY LOVE - Trang Hàn x TDK x Hoàng Thống.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/SÀI GÒN TÔI MƯA - TUYÊN (ft. MC GOKU).mp3",
        ...
        },
        {
            ...
            singer: "Yasuha",
            path: "./assets/music/Flyday Chinatown - Yasuha.mp3",
            image: "./assets/img/flydaychinatown.jpg",
        },
        {
            name: "노래(THE SONG)",
            singer: "Zion.T",
            path: "./assets/music/노래(THE SONG) - Zion.T.mp3",
        ...
        },
        {
            name: "밤양갱",
            singer: "비비 (BIBI)",
            path: "./assets/music/밤양갱 - BIBI.mp3",
            image: "./assets/img/bibi.jpg",
        },
        {
            name: "어디쯤에 (Somewhere) (instrumental)",
            singer: "Groovyroom",
            path: "./assets/music/어디쯤에 (Somewhere) (inst.) - Groovyroom.mp3",
            image: "./assets/img/somewhere.jpg",
        },
        {
        ...
        },
        {
            ...
            singer: "MCK",
            path: "./assets/music/AI MỚI LÀ KẺ XẤU XA - RPT MCK.mp3",
            image: "./assets/img/aimoilakexauxa.jpg",
        },
        {
            name: "Super Rare",
            singer: "Epik High (에픽하이) ft. Wonstein, pH-1",
            path: "./assets/music/Super Rare - Epik High (에픽하이) ft. Wonstein, pH-1.mp3",
            image: "./assets/img/superrare.jpg",
        },
        {
            name: "그 해 우리는(Our Beloved Summer)",
            singer: "10CM - 서랍",
            path: "./assets/music/그 해 우리는(Our Beloved Summer) - 10CM.mp3",
            image: "./assets/img/그 해 우리는(Our Beloved Summer).jpg",
        },
        {
            name: "IF YOU",
            singer: "BIGBANG",
            path: "./assets/music/TOUR REPORT 'IF YOU' - BIGBANG.mp3",
            image: "./assets/img/ifyou.jpg",
        },
        {
            name: "디오 괜찮아도 괜찮아 (That's okay)",
            singer: "D.O.",
            path: "./assets/music/디오 괜찮아도 괜찮아 (That's okay) - D.O..mp3",
            image: "./assets/img/thatokay.jpg",
        },
        {
            name: "Đánh Mất Em (丢了你)",
            singer: "Tỉnh Lung (井胧)",
            path: "./assets/music/Đánh Mất Em - Tỉnh Lung.mp3",
            image: "./assets/img/danhmatem.jpg",
        },
        {
            name: "Đáp Án (答案)",
            singer: "Phương Vũ Kiệt (方宇杰)",
            path: "./assets/music/Đáp Án - Phương Vũ Kiệt.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Đợi em tan học - Jay Chou & Dương Thụy Đại.mp3",
            image: "./assets/img/doiemtanhoc.jpg",
        },
        {
            name: "HOME SWEET HOME",
            singer: "G-DRAGON (feat. TAEYANG & DAESUNG)",
            path: "./assets/music/HOME SWEET HOME - G. DRAGON (feat. TAEYANG & DAESUNG).mp3",
            image: "./assets/img/homesweethome.jpg",
        },
        {
            name: "무제(無題) (Untitled, 2014)",
            singer: "G-DRAGON",
            path: "./assets/music/무제(無題) (Untitled, 2014) - G. DRAGON.mp3",
            image: "./assets/img/untitled.jpg",
        },
        {
            name: "안녕히 (Adios)",
            singer: "Hoody (후디) - (Feat. GRAY)",
            path: "./assets/music/안녕히 (Adios) - Hoody (후디) (Feat. GRAY).mp3",
            image: "./assets/img/adios.jpg",
        },
        {
            name: "No Make Up(노메이크업)",
            singer: "Zion.T(자이언티)",
            path: "./assets/music/No Make Up(노메이크업) - Zion.T.mp3",
            image: "./assets/img/nomakeup.jpg",
        },
        {
            name: "YOU",
            singer: "JISOO",
            path: "./assets/music/YOU - JISOO.mp3",
            image: "./assets/img/jisoo.jpg",
        },
        {
            name: "Say it",
            singer: "LuHan (鹿晗)",
            path: "./assets/music/Say it - LuHan鹿晗.mp3",
            image: "./assets/img/sayit.jpg",
        },
        {
            name: "Skin to Skin",
            singer: "LuHan (鹿晗)",
            path: "./assets/music/Skin to Skin - LuHan鹿晗.mp3",
            image: "./assets/img/skintoskin.jpg",
        },
        {
            name: "WHAT IF I SAID",
            singer: "LuHan (鹿晗)",
            path: "./assets/music/WHAT IF I SAID - LuHan鹿晗.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Yours - Raiden X CHANYEOL (Feat. LeeHi, CHANGMO).mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Obsession - 민니(MINNIE) (Feat. TEN of WayV).mp3",
            image: "./assets/img/minnie.jpg",
        },
        {
            name: "Blue",
            singer: "Bolbbalgan4 (볼빨간사춘기)",
            path: "./assets/music/Blue - Bolbbalgan4.mp3",
            image: "./assets/img/blue.jpg",
        },
        {
            name: "慢慢 (Slow Motion)",
            singer: "LuHan (鹿晗)",
            path: "./assets/music/慢慢  Slow Motion - 鹿晗LuHan.mp3",
            image: "./assets/img/slowmotion.jpg",
        },
        {
            name: "Your Song (acoustic ver. Live)",
            singer: "Luhan",
            path: "./assets/music/Your Song (acoustic ver. Live) - Luhan.mp3",
            image: "./assets/img/luhan.jpg",
        },
        {
            name: "Glorious",
            singer: "Macklemore (feat. Skylar Grey)",
            path: "./assets/music/Glorious - Macklemore (feat. Skylar Grey).mp3",
        ...
        },
        {
            ...
            singer: "Shawn Mendes",
            path: "./assets/music/Treat You Better - Shawn Mendes.mp3",
            image: "./assets/img/treatyoubetter.png",
        },
        {
            name: "Mama Said",
            singer: "Lukas Graham",
            path: "./assets/music/Mama Said - Lukas Graham.mp3",
            image: "./assets/img/mamasaid.jpg",
        },
        {
            name: "7 Years",
            singer: "Lukas Graham",
            path: "./assets/music/7 Years - Lukas Graham.mp3",
            image: "./assets/img/7years.jpg",
        },
        {
            name: "These Days (Cover)",
            singer: "Bars and Melody",
            path: "./assets/music/These Days (COVER) - Bars and Melody.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Omakase - ATARASHII GAKKO!.mp3",
            image: "./assets/img/omakase.jpg",
        },
        {
            name: "Biết rõ vẫn khó đi",
            singer: "DSK",
            path: "./assets/music/Biết rõ vẫn khó đi - DSK.mp3",
            image: "./assets/img/bietrokhovandi.jpg",
        },
        {
            name: "Ngày tàn",
            singer: "DSK",
            path: "./assets/music/NGÀY TÀN ( LIVE AT KONG 13-11-2017 ) - DSK.mp3",
            image: "./assets/img/ngaytan.jpg",
        },
        {
            name: "FAN CỦA TAO",
            singer: "DSK",
            path: "./assets/music/FAN CỦA TAO - DSK.mp3",
            image: "./assets/img/fancuatao.jpg",
        },
        {
            name: "Matsuri",
            singer: "Fujii Kaze",
            path: "./assets/music/Matsuri - Fujii Kaze.mp3",
            image: "./assets/img/matsuri.jpg",
        },
        {
            name: "Hà Nội Của Bố",
            singer: "Tamka PKL",
            path: "./assets/music/Hà Nội Của Bố - Tamka PKL.mp3",
            image: "./assets/img/hanoicuabo.jpg",
        },
        {
            name: "NOAH (Prod. GroovyRoom)",
            singer: "HAON (feat. 박재범, Hoody)",
            path: "./assets/music/NOAH - HAON (feat. 박재범, Hoody) (Prod. GroovyRoom).mp3",
            image: "./assets/img/noah.jpg",
        },
        {
            name: "Lớn rồi",
            singer: "DSK",
            path: "./assets/music/Lớn rồi - DSK.mp3",
            image: "./assets/img/lonroi.jpg",
        },
        {
            name: "Happy For You",
            singer: "Lukas Graham (feat. Vũ.)",
            path: "./assets/music/Happy For You - Lukas Graham (feat. Vũ.).mp3",
            image: "./assets/img/happyforyou.jpg",
        },
        {
            name: "Sunflower",
            singer: "Post Malone, Swae Lee",
            path: "./assets/music/Sunflower (Spider Man Into the Spider Verse) - Post Malone, Swae Lee.mp3",
            image: "./assets/img/sunflower.jpg",
        },
        {
            name: "Some Love",
            singer: "DSK",
            path: "./assets/music/Some Love - DSK.mp3",
            image: "./assets/img/somelove.jpg",
        },
        {
            name: "Closer",
            singer: "The Chainsmokers",
            path: "./assets/music/Closer - The Chainsmokers ft. Halsey.mp3",
            image: "./assets/img/closer.png",
        },
        {
            name: "Friend Of Mine",
            singer: "Avicii ft. Vargas & Lagola",
            path: "./assets/music/Friend Of Mine - Avicii ft. Vargas & Lagola.mp3",
            image: "./assets/img/friendofmine.jpg",
        },
        {
            name: "Lonely Together",
            singer: "Avicii ft. Rita Ora",
            path: "./assets/music/Lonely Together - Avicii ft. Rita Ora.mp3",
            image: "./assets/img/lonelytogether.jpg",
        },
        {
            name: "Sunset Jesus",
            singer: "Avicii",
            path: "./assets/music/Sunset Jesus - Avicii.mp3",
            image: "./assets/img/sunsetjesus.jpg",
        },
        {
            name: "Fades Away (Tribute Concert Version)",
            singer: "Avicii ft. MishCatt",
            path: "./assets/music/Fades Away (Tribute Concert Version at Friends Arena, Stockholm, 2019) - MishCatt.mp3",
            image: "./assets/img/fadesaway.jpg",
        },
        {
            name: "It Ain't Me",
            singer: "Kygo, Selena Gomez",
            path: "./assets/music/It Ain't Me - Kygo, Selena Gomez.mp3",
            image: "./assets/img/itaintme.png",
        },
        {
            name: "Father",
            singer: "Dongmakgol girl",
            path: "./assets/music/Father - Dongmakgol girl.mp3",
        ...
        },
        {
            name: "2U (Cover)",
            singer: "BTS Jungkook",
            path: "./assets/music/2U (Cover) - BTS Jungkook.mp3",
            image: "./assets/img/jk2u.jpg",
        },
        {
            name: "Sing For You",
            singer: "EXO",
            path: "./assets/music/Sing For You - EXO.mp3",
            image: "./assets/img/singforyou.jpg",
        },
        {
            name: "탕! (TANG!)",
            singer: "MINO",
            path: "./assets/music/탕! (TANG!) - MINO.mp3",
            image: "./assets/img/tang.jpg",
        },
        {
            name: "We don't talk together (Prod. SUGA)",
            singer: "헤이즈 (Heize) (Feat. 기리보이 (Giriboy))",
            path: "./assets/music/We don't talk together - 헤이즈 (Heize) (Feat. 기리보이 (Giriboy)) (Prod. SUGA).mp3",
            image: "./assets/img/wedonttalktogether.jpg",
        },
        {
            name: "Temporary",
            singer: "Eminem (feat. Skylar Grey)",
            path: "./assets/music/Temporary - Eminem (feat. Skylar Grey).mp3",
            image: "./assets/img/temporary.jpg",
        },
        {
            name: "Numb Little Bug (Piano Version Video)",
            singer: "Em Beihold",
            path: "./assets/music/Numb Little Bug (Piano Version Video) - Em Beihold.mp3",
            image: "./assets/img/numblittlebug.png",
        },
        {
            name: "Adventure Of A Lifetime (Audien Remix)",
            singer: "Coldplay",
            path: "./assets/music/Adventure Of A Lifetime (Audien Remix) - Coldplay.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/You Be Love - Avicii ft. Billy Raffoul.mp3",
        ...
        },
        {
            ...
            singer: "Nguyễn Hùng",
            path: "./assets/music/Còn Gì Đẹp Hơn (Mưa Đỏ Original Soundtrack) - Nguyễn Hùng.mp3",
            image: "./assets/img/congidephon.png",
        },
        {
            name: "Feel so cold",
            singer: "Carpetman",
            path: "./assets/music/Feel so cold - Carpetman.mp3",
        ...
        },
        {
            ...
            singer: "Carpetman",
            path: "./assets/music/You Will Never Know It - Carpetman.mp3",
            image: "./assets/img/carpetman.jpg",
        },
        {
            name: "Upgrade",
            singer: "Steve Medea",
            path: "./assets/music/Upgrade - Steve Medea.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/MỘT NGÀY NÀO ĐÓ - HOÀNG DŨNG (feat. ĐEN & BẠN NHẠC).mp3",
            image: "./assets/img/motngaynaodo.webp",
        },
        {
            name: "NẾU MỘT NGÀY CHÚNG TA KHÔNG CÒN GẶP",
            singer: "DICK (ft. 2CAN)",
            path: "./assets/music/NẾU MỘT NGÀY CHÚNG TA KHÔNG CÒN GẶP - DICK ft. 2CAN.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/차차차 (CHA CHA CHA) - Vince (feat. G. DRAGON).mp3",
            image: "./assets/img/chachacha.jpg",
        },
        {
            name: "Đừng nhìn lại thẳng mặt mà đi",
            singer: "Mikelodic",
            path: "./assets/music/Đừng nhìn lại thẳng mặt mà đi - Mikelodic.mp3",
            image: "./assets/img/dungnhinlaithangmatmadi.jpg",
        },
        {
            name: "DẪU CÓ LỖI LẦM",
            singer: "LIÊN MINH PHÁT TÀI",
            path: "./assets/music/DẪU CÓ LỖI LẦM - LIÊN MINH PHÁT TÀI.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Cô Gái Bàn Bên - Đen ft. Lynk Lee.mp3",
        ...
        },
        {
            name: "LIMBO",
            singer: "keshi",
            path: "./assets/music/LIMBO - keshi.mp3",
            image: "./assets/img/limbo-keshi.jpg",
        },
        {
            name: "Kiss Me Right",
            singer: "keshi",
            path: "./assets/music/Kiss Me Right - keshi.mp3",
        ...
        },
        {
            ...
            singer: "Hà Anh Tuấn",
            path: "./assets/music/Tháng Tư Là Lời Nói Dối Của Em - Hà Anh Tuấn.mp3",
        ...
        },
        {
            ...
            singer: "Lệ Quyên",
            path: "./assets/music/Giấc Mơ Có Thật - Lệ Quyên.mp3",
            image: "./assets/img/giacmocothat.jpg",
        },
        {
            name: "Rasputin",
            singer: "Boney M",
            path: "./assets/music/Rasputin - Boney M..mp3",
            image: "./assets/img/rasputin.jpg",
        },
        {
            name: "Rasputin's Hotel Room Service",
            singer: "Boney M. x Pitbull",
            path: "./assets/music/Rasputin's Hotel Room Service - Boney M. x Pitbull.mp3",
            image: "./assets/img/rasputin.png",
        },
        {
            name: "THIÊN NGỰ NGUYÊN",
            singer: "T9 - prod. NGÔ HẠO [Địa Ngục Trần Gian x Anh Vui REMAKE - Phạm Kỳ]",
            path: "./assets/music/THIÊN NGỰ NGUYÊN - T9 prod. NGÔ HẠO [Địa Ngục Trần Gian x Anh Vui REMAKE - Phạm Kỳ].mp3",
            image: "./assets/img/thienngunguyen.jpg",
        },
        {
            name: "酔いどれ知らず",
            singer: "[GUMI]Kanaria",
            path: "./assets/music/Kanaria - GUMI酔いどれ知らず.mp3",
            image: "./assets/img/gumi.jpg",
        },
        {
            name: "Con kể Ba nghe",
            singer: "Obito",
            path: "./assets/music/Con kể Ba nghe - Obito.mp3",
            image: "./assets/img/conkebanghe.jpg",
        },
        {
            name: "Đánh Đổi",
            singer: "Obito ft. MCK",
            path: "./assets/music/Đánh Đổi - Obito.mp3",
            image: "./assets/img/danhdoi.jpg",
        },
        {
            name: "Đầu Đường Xó Chợ",
            singer: "Obito ft. Lăng LD",
            path: "./assets/music/Đầu Đường Xó Chợ - Obito.mp3",
            image: "./assets/img/dauduongxocho.jpg",
        },
        {
            name: "Sài Gòn ơi",
            singer: "Obito",
            path: "./assets/music/Sài Gòn ơi - Obito.mp3",
            image: "./assets/img/saigonoi.jpg",
        },
        {
            name: "The Nights",
            singer: "Avicii",
            path: "./assets/music/The Nights - Avicii.mp3",
            image: "./assets/img/thenighstavicii.jpg",
        },
        {
            name: "Levels",
            singer: "Avicii",
            path: "./assets/music/Levels - Avicii.mp3",
        ...
        },
        {
            name: "Bên Trái",
            singer: "Kiên Trịnh",
            path: "./assets/music/BÊN TRÁI - Kiên Trịnh.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/GIỮ ANH CHO NGÀY HÔM QUA - HOÀNG DŨNG (feat. RHYMASTIC).mp3",
            image: "./assets/img/giuanhchongayhomqua.jpg",
        },
        {
            name: "Khóc Đấy",
            singer: "Thắng",
            path: "./assets/music/Khóc Đấy - Thắng.mp3",
            image: "./assets/img/khocday.png",
        },
        {
            name: "ĐỪNG VỀ TRỄ",
            singer: "LĂNG LD ft. OBITO (prod. Thái Sơn Beatbox)",
            path: "./assets/music/ĐỪNG VỀ TRỄ - LĂNG LD ft. OBITO (prod. Thái Sơn Beatbox).mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Panorama - Richie D. ICY x Obito.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Nắng Ấm Trong Tim - Duongg (prod. by Dadeon).mp3",
        ...
        },
        {
            ...
            singer: "Sơn Tùng MTP",
            path: "./assets/music/Chúng Ta Của Hiện Tại - Sơn Tùng MTP.mp3",
            image: "./assets/img/chungtacuahientai.webp",
        },
        {
            name: "Đồng Ý (kết hợp với Thơ Tơ Mơ)",
            singer: "Thắng",
            path: "./assets/music/Đồng Ý - Thắng (kết hợp với Thơ Tơ Mơ).mp3",
        ...
        },
        {
            name: "Ai Ngoài Anh",
            singer: "VSTRA",
            path: "./assets/music/Ai Ngoài Anh - VSTRA.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/vì - marzuz ft. justatee.mp3",
        ...
        },
        {
            name: "Bút Chì Bạc",
            singer: "Thắng",
            path: "./assets/music/Bút Chì Bạc - Thắng.mp3",
            image: "./assets/img/caithu2.jpg",
        },
        {
            name: "Căn Gác Lặng",
            singer: "Thắng",
            path: "./assets/music/Căn Gác Lặng - Thắng.mp3",
            image: "./assets/img/caithu2.jpg",
        },
        {
            name: "Gội Đầu",
            singer: "Thắng (feat. Hà Lê)",
            path: "./assets/music/Gội Đầu - Thắng (feat. Hà Lê).mp3",
            image: "./assets/img/caithu2.jpg",
        },
        {
            name: "Đã Xem",
            singer: "Thắng",
            path: "./assets/music/Đã Xem - Thắng.mp3",
            image: "./assets/img/daxemthang.jpg",
        },
        {
            name: "Hình Trái Tim",
            singer: "Thắng (với Vũ Thanh Vân)",
            path: "./assets/music/Hình Trái Tim - Thắng (với Vũ Thanh Vân).mp3",
            image: "./assets/img/hinhtraitim.jpg",
        },
        {
            name: "Imma heartbreaker",
            singer: "JustaTee (feat. LK & Emily)",
            path: "./assets/music/Imma heartbreaker - Justatee (feat. LK & Emily).mp3",
            image: "./assets/img/justatee.jpg",
        },
        {
            name: "She Neva Knows",
            singer: "JustaTee",
            path: "./assets/music/She Neva Knows - JustaTee.mp3",
            image: "./assets/img/shenevaknows.jpg",
        },
        {
            name: "Người Nào Đó",
            singer: "JustaTee",
            path: "./assets/music/Người Nào Đó - Justatee.mp3",
            image: "./assets/img/justatee.jpg",
        },
        {
            name: "New New",
        ...
        },
        {
            ...
            path: "./assets/music/NGONGIODEMQUATRANGSANGDEMNAY - NGHIÊM TỔNG & TRẦN TIỂU MUỘI (prod. NGÔ HẠO & MAI CẢNH DỊ).mp3",
            image: "./assets/img/NGONGIODEMQUATRANGSANGDEMNAY.jpg",
        },
        {
            name: "Tình Nhân Muôn Kiếp",
            singer: "Thắng",
            path: "./assets/music/Tình Nhân Muôn Kiếp - Thắng.mp3",
            image: "./assets/img/caithu2.jpg",
        },
        {
            name: "mới hôm qua",
            singer: "Grey D",
            path: "./assets/music/mới hôm qua - Grey D.mp3",
            image: "./assets/img/moihomqua.jpg",
        },
        {
            name: "hoá ra…",
            singer: "Grey D",
            path: "./assets/music/hoá ra… - Grey D.mp3",
            image: "./assets/img/hoara.png",
        },
        {
            name: "2010 Pop Mashup (Pop Danthology 2010)",
            singer: "Daniel Kim",
            path: "./assets/music/Pop Danthology 2010 - Daniel Kim.mp3",
            image: "./assets/img/2010popdance.png",
        },
        {
            name: "2011 Pop Mashup (Pop Danthology 2011)",
            singer: "Daniel Kim",
            path: "./assets/music/Pop Danthology 2011 - Daniel Kim.mp3",
            image: "./assets/img/2011popdance.jpg",
        },
        {
            name: "Pop Danthology 2012 - Mashup of 50+ Pop Songs",
            singer: "Daniel Kim",
            path: "./assets/music/Pop Danthology 2012 - Daniel Kim.mp3",
            image: "./assets/img/2012popdance.jpg",
        },
        {
            name: "Pop Danthology 2013 - Mashup of 68 songs!",
            singer: "Daniel Kim",
            path: "./assets/music/Pop Danthology 2013 - Daniel Kim.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Bad Day - Daniel Powter.mp3",
            image: "./assets/img/badday.jpg",
        },
        {
            name: "Free Loop",
            singer: "Daniel Powter",
            path: "./assets/music/Free Loop - Daniel Powter.mp3",
            image: "./assets/img/freeloop.jpg",
        },
        {
            name: "I'm the One",
            singer: "DJ Khaled ft. Justin Bieber, Chance the Rapper, Lil Wayne",
            path: "./assets/music/I'm the One - DJ Khaled ft. Justin Bieber, Chance the Rapper, Lil Wayne.mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Somebody That I Used To Know - Gotye (feat. Kimbra).mp3",
        ...
        },
        {
            ...
            path: "./assets/music/Cold Water - Major Lazer (feat. Justin Bieber & MØ).mp3",
